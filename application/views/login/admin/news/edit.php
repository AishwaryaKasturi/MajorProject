	...
	<div class="row">
		<div class="col-sm-12">
			<div class="form-group">
				...
				<input type="text" class="form-control title" size="150" value="<?= $news->title?>" id="title" name="title" placeholder="Enter News Title" />
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="form-group">
				...
				<textarea class="form-control body" width="48" height="48" id="body" name="body" rows="10" placeholder="Enter News Body"><?= $news->body?></textarea>
